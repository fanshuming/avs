...
typedef enum _SSPP_CMD
{
	...
	SSPP_CMD_SONG_PATH_MODE, //6
	SSPP_CMD_PROMPT_TONE, //7
	SSPP_CMD_NETWORK_STATE, //8
	SSPP_CMD_MAX,
} SSPP_CMD;

typedef enum _flash_play
{
	UNKOWN = 0,
	RESPONSE,        //请稍等
	NETERR,            //网络连接异常，请稍后重试
